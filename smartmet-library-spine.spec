...
- Thread naming: Renamed plugin/engine load and shutdown tasks (ld-p-*, ld-e-*, sd-p-*, sd-e-*) and named the log-cleaner and shutdown-watch threads
...
- Added method Reactor::getConfig
...
- Fixed WSI parameter to be data independent
...
- Added thread pool settings for admin plugins
...
* Mon Sep  5 2022 Andris Pavēnis <andris.pavenis@fmi.fi> 22.9.5-1.fmi
- Reactor: add method isURIPrefix(const std::string&) const
...
* Fri Apr 29 2022 Andris Pavēnis <andris.pavenis@fmi.fi> 22.4.29-1.fmi
- ConfigBase: fix incorrect ues of class member instead of parameter
